...
Raw data from SAMM, Idaho's statewide database, is on the left. The two tabs in this window are Raw and Raw minimized, which removes some of the columns from the Raw tab to make it easier to navigate. The empty box at the top of each column is a keyword search.
