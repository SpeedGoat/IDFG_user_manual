...
Data Analysis Units separate Idaho into distinct management areas for each species. Each one has a specific name and is further divided into subunits, which allow even more specificity.
...
###### Unit {#gl-unit -}
Another name for a GMU, or Game Management Unit, which is a subdivision of Idaho with its own unique hunting and game regulations managed by Idaho Department of Fish and Game. 
